/* ---------- data ---------- */
  ...
  /* ---------- render collection ---------- */
  document.getElementById('collectionGrid').innerHTML = COLLECTION.map(([n,c]) => `
  ...
  /* ---------- render universes ---------- */
  document.getElementById('universesGrid').innerHTML = UNIVERSES.map(([n,g]) => `
  ...
  /* ---------- render lifestyle ---------- */
  document.getElementById('lifestyleGrid').innerHTML = LIFESTYLE.map(([t,s,d]) => `
  ...
  /* ---------- render values strip ---------- */
  document.getElementById('valuesStrip').innerHTML = VALUES.map(([t,d]) => `
